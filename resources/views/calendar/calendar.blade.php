...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            @php
                $global = \App\Http\Controllers\EventController::show();
            @endphp
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="input-group">
                                            <form action="{{ asset('/claendar/create') }}" method="post">
                                                @csrf
                ...
                events: [
                    ...
                    ?>

                        {
                            ...
                            description: '<?php echo $event->descripcion; ?>',
