        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <h1>
                        <!-- < tutofox /> <small>Oh my code!</small></h1> -->

                        <p>Detalles de evento</p>
                        <!-- <a class="btn btn-default" href="{{ asset('/Evento/index') }}"></a> -->
                        <hr>
                        <div class="col-md-6">
                            <form action="{{ route('eventdetails', $event->id) }} }}" method="post">
                                {{ csrf_field() }}
                                {{ method_field('DELETE') }}
